...
def photdriver(classification_output_filename, combined_photometry_filename, directory):
    ...
    good_density_histogram_status_test = coord_density_histogram(blc_good_rates, blc_good_test_rate_errs, directory, True, 'full_data_set', 'Good')
    multi_density_histogram_status_test = coord_density_histogram(blc_multi_rates, blc_multi_test_rate_errs, directory, True, 'full_data_set', 'Multi')
...
def coord_density_histogram(ratevec, rate_errvec, directory, test, strkey, label):
    ...
    plt.xlim([-90., 90.])
    plt.xticks([-90., -60., -30., 0., 30., 60., 90.])
    plt.ylabel(label+" rate",fontsize=18)
...
def get_background_galaxies(classified_good_vec):
    ...
    for good_subject in classified_good_vec:
        ...
        contamination_fraction = contaminants_per_steradian * w4_beam_steradians
